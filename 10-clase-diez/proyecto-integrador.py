...
def actualizar_lista():
    ...
    for a in db:
        texto = f"{a.id} - {a.nombre} {a.apellido} ({a.cantidad_cursos} cursos)"
...
def cargar_seleccion():
    ...
    entry_nombre.insert(0, a.nombre)

    entry_apellido.delete(0, tk.END)
    entry_apellido.insert(0, a.apellido)

    entry_cursos.delete(0, tk.END)
    entry_cursos.insert(0, a.cantidad_cursos)
...
def modificar_alumno():
    ...
    try:
        ...
        a.nombre = entry_nombre.get()
        a.apellido = entry_apellido.get()
        a.cantidad_cursos = int(entry_cursos.get())
